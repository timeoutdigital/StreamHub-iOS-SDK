...
//
// Note: this is a hotfix code, pulled from AFNetworking.
// Use StreamHub-iOS-SDK v0.2.0-RC1 or later to avoid problems
// with query strings
//
...
{
    return [self queryStringWithEncoding:NSUTF8StringEncoding];
}

- (NSString*)queryStringWithEncoding:(NSStringEncoding)stringEncoding
{
    return AFQueryStringFromParametersWithEncoding(self, stringEncoding);
}
